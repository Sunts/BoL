...
local function AutoupdaterMsg(msg) print('<font color=\'#6699ff\'><b>Orianna:</b></font> <font color=\'#FFFFFF\'>'..msg..'.</font>') end
...
function OnLoad()
	...
	if VP.version == nil or type(tonumber(VP.version)) ~= "number" or tonumber(VP.version) < 3 then
		...
		DownloadFile('https://raw.github.com/Sunts/BoL/master/VPrediction.lua?rand=' .. math.random(1,10000), LIB_PATH..'vPrediction.lua', function () print('All files were downloaded successfully, F9 twice pls!') end)
		return
	end
...
AutoupdaterMsg('Orianna ('..version..') loaded!')
